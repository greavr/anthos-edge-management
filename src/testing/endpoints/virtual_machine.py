...
async def image_list():
    """ This function returns a list of images which can be deployed on ABM : TESTING - ALWAYS SUCESS"""
...
async def parameter_list():
    """ This function returns a list of parameters which can be deployed on ABM : TESTING - ALWAYS SUCESS"""
